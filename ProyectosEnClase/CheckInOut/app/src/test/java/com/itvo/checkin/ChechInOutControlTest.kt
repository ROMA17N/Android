    ...
    fun testRegisterCheckInOut(){
        checkInOutControl.registerCheckInOut(
            CheckInOut(employee = employee,
                ...
                checkIn = LocalTime.of(8,0,0),
                checkOut = LocalTime.of(15,5,0))
        )
        checkInOutControl.registerCheckInOut(
            CheckInOut(employee = employee,
                date = LocalDate.of(2025,2,14),
                checkIn = LocalTime.of(8,15,0),
                checkOut = LocalTime.of(15,5,0))
        )
    }
// -----------------TEST DE RETARDO ------------------------
    @Test
    fun testCalculateIncidenceForPeriodShouldReturnOneDelays() {
        testAddSchedule()
        ...
        val incidence = checkInOutControl.calculateIncidenceForPeriod(
            ...
            period = Period(
                ...
                finalDate = LocalDate.of(2025, 2, 17)
            )
        )
        assertEquals(1, incidence.delays)
    }
}
